...
namespace ALPAKA_ACCELERATOR_NAMESPACE::testConditionsSoA {  
  ...
  public:
    ...
    ALPAKA_FN_ACC void operator()(
      ...
      SiStripClusterizerConditionsData_apvView Data_apvSoA_view
    ) const {
  ...
  void runKernels(SiStripClusterizerConditionsDetToFedsView DetToFedsView, SiStripClusterizerConditionsData_fedchView Data_fedchView, SiStripClusterizerConditionsData_stripView Data_stripView, SiStripClusterizerConditionsData_apvView Data_apvView, Queue& queue) {
    uint32_t items = 640;
    ...
    alpaka::exec<Acc1D>(queue, workDiv, TestVerifyKernel{}, DetToFedsView, Data_fedchView, Data_stripView, Data_apvView);
  }
