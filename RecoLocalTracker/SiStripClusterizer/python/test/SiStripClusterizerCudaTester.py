...
process.hltSiStripClusterizerConditionsGPUESProducer = SiStripClusterizerConditionsGPUESProducer

process.hltSiStripClusterizerFromRawGPU = siStripClusterizerFromRawGPU
process.hltSiStripClustersSOAtoHost = siStripClustersSOAtoHost
process.hltSiStripClustersFromSOA = siStripClustersFromSOA
...
process.HLTDoLocalStripSequence = cms.Sequence( process.hltSiStripExcludedFEDListProducer
                                               + process.hltSiStripRawToClustersFacility
                                               + process.hltMeasurementTrackerEvent )
process.HLTDoLocalStripSequence_cuda = cms.Sequence( process.hltSiStripExcludedFEDListProducer + process.hltSiStripClusterizerFromRawGPU + process.hltSiStripClustersSOAtoHost + process.hltSiStripClustersFromSOA)
process.HLTEndSequence = cms.Sequence( process.hltBoolEnd )


process.MC_ReducedIterativeTracking_v22 = cms.Path( process.HLTBeginSequence
                                                   + process.HLTDoLocalStripSequence
                                                   + process.HLTDoLocalStripSequence_cuda
